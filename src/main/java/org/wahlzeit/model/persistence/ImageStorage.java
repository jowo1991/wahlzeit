 ...
 * @review
 */
@PatternInstance(name = "Template, Singleton, Adapter", participants = {"Template: ImageStorage, DatastoreAdapter", "Singleton: ImageStorage", "Adapter:ImageStorage, DatastoreAdapter"})
